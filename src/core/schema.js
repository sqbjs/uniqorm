...
class Schema {
    ...
    constructor(name, db) {
        ...
        const models = new Proxy({}, {
            get: function (object, name) {
                return typeof name === 'string' ? object[name.toUpperCase()] : undefined;
            },
        ...
        Object.defineProperty(this, 'models', {value: models, configurable: false, writable: false});
    }
    ...
    define(obj) {
        ...
        Object.defineProperty(ctor, "schema", {value: this, writable: false, configurable: false});
        Object.defineProperty(ctor.prototype, "schema", {value: this, writable: false, configurable: false});
    ...
    load(dir, callback) {
                ...
                fs.readdir(dir, function (err, files) {
                    ...
                    for (let i = 0; i < files.length; i++) {
                        try {
                            ...
                            assert.ok(ctor.prototype instanceof Model, `File (${files[i]}) does not export Model class`);
                            self.define(ctor);
                        } catch (e) {
                            reject(e);
                            return;
        ...
        return !callback ? promise : promise.then(() => callback).catch(err => callback(err));
    }
}
