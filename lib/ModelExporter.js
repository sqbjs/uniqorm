 ...
 * @constructor
 */
function ModelExporter(dbPool, options) {
  EventEmitter.call(this);
}

Object.setPrototypeOf(ModelExporter.prototype, EventEmitter.prototype);

ModelExporter.prototype.execute = function(pool, options, callback) {
  const self = this;
