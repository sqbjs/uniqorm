...
class AssociatedField extends Field {
   ...
   */
  get towards() {
    if (!this._towards && this._def.towards && !this.field) {
  ...
  get returnsSingleValue() {
    return !!this.field || (this.towards && this.towards.returnsSingleValue);
  }

  returnsAttribute(attribute) {
    return (this.attributes && this.attributes.hasOwnProperty(attribute)) ||
        (this.towards && this.towards.returnsAttribute(attribute));
  }
  ...
  prepare() {
    ...
    if (!this._def.field && !this._def.attributes && !this.towards)
    ...
    if (!(this._key && this._foreignKey)) {
      ...
      for (const asc of this.model.associations.values()) {
    ...
    if (!(this._key && this._foreignKey)) {
      ...
      for (const asc of this.foreignModel.associations.values()) {
